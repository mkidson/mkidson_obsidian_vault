...
- [ ] Slide 10: Transition feels abrupt. Simplify it by linking it to the response functions and make a high level argument for simulating response functions, then high level summary of the two approaches
